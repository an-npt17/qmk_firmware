...
enum layers { _BASE = 0, _SHIFT, _EXTEND, _SYMBOLS, _FUNCTION, _NUMBERS };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     *            `----------------------------------'           '------''---------------------------'
     */
    [_BASE] = LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_GRV, KC_TAB, KC_Q, KC_W, KC_F, KC_P, KC_B, KC_J, KC_L, KC_U, KC_Y, KC_QUOT, KC_BSPC, KC_LCTL, KC_A, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, KC_O, KC_MINS, KC_LSFT, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_MUTE, KC_MPLY, KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LGUI, KC_LALT, MO_EXT, SFT_BSP, KC_SPC, KC_ENT, MO_SYM, NUM_TAB, KC_RALT, KC_RGUI),
     ...
     *            `----------------------------------'           '------''---------------------------'
     */
    [_SHIFT] = LAYOUT(_______, S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5), S(KC_6), S(KC_7), S(KC_8), S(KC_9), S(KC_0), KC_TILD, _______, S(KC_Q), S(KC_W), S(KC_F), S(KC_P), S(KC_B), S(KC_J), S(KC_L), S(KC_U), S(KC_Y), KC_DQUO, KC_DEL, _______, S(KC_A), S(KC_R), S(KC_S), S(KC_T), S(KC_G), S(KC_M), S(KC_N), S(KC_E), S(KC_I), S(KC_O), KC_UNDS, _______, S(KC_Z), S(KC_X), S(KC_C), S(KC_D), S(KC_V), _______, _______, S(KC_K), S(KC_H), KC_LT, KC_GT, KC_QUES, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
     ...
     */
    [_EXTEND] = LAYOUT(_______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, _______, KC_ESC, C(KC_C), C(KC_F), C(KC_V), XXXXXXX, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_DEL, KC_F12, _______, OS_LALT, OS_LGUI, OS_LSFT, OS_LCTL, OS_RALT, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, KC_INS, _______, C(KC_Z), C(KC_X), C(KC_C), XXXXXXX, C(KC_V), _______, _______, XXXXXXX, KC_TAB, XXXXXXX, KC_ENT, KC_APP, _______, _______, _______, _______, _______, _______, _______, MO_FUN, _______, _______, _______),
     ...
     *            `----------------------------------'           '------''---------------------------'
     */
    [_SYMBOLS] = LAYOUT(_______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_TILD, KC_GRV, _______, _______, OS_LALT, OS_LGUI, OS_LSFT, OS_LCTL, OS_RALT, KC_SCLN, KC_LPRN, KC_LCBR, KC_LBRC, KC_COLN, KC_BSLS, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, KC_PLUS, KC_RPRN, KC_RCBR, KC_RBRC, KC_EQL, KC_PIPE, _______, _______, MO_FUN, _______, _______, _______, _______, _______, _______, _______),
     ...
     *            `----------------------------------'           '------''---------------------------'
     */
    [_FUNCTION] = LAYOUT(QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, KC_BRID, KC_BRIU, XXXXXXX, XXXXXXX, XXXXXXX, KC_F12, KC_F7, KC_F8, KC_F9, XXXXXXX, _______, _______, OS_LALT, OS_LGUI, OS_LSFT, OS_LCTL, OS_RALT, KC_F11, KC_F4, KC_F5, KC_F6, XXXXXXX, _______, _______, KC_MPRV, KC_MNXT, KC_VOLD, KC_VOLU, KC_MUTE, _______, KC_MPLY, KC_F10, KC_F1, KC_F2, KC_F3, XXXXXXX, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
     ...
     *            `----------------------------------'           '------''---------------------------'
     */
    [_NUMBERS] = LAYOUT(_______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSLS, KC_7, KC_8, KC_9, KC_PMNS, _______, _______, OS_LALT, OS_LGUI, OS_LSFT, OS_LCTL, OS_RALT, KC_PAST, KC_4, KC_5, KC_6, KC_PPLS, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, KC_0, KC_1, KC_2, KC_3, KC_PDOT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______)};
