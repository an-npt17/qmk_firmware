...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /*
     * Layer 2: EXTEND (Navigation Layer - matches Redox Seniply)
     *
     * ,-----------------------------------------.                    ,-----------------------------------------.
     * |      |  F1  |  F2  |  F3  |  F4  |  F5  |                    |  F6  |  F7  |  F8  |  F9  | F10  |      |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |      | Esc  |A+Lft | C+F  |A+Rgt | Ins  |                    | PgUp | Home |  Up  | End  | Caps |      |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |      | Alt  | GUI  |Shift | Ctrl | RAlt |-------.    ,-------| PgDn | Left | Down |Right | Del  |      |
     * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
     * |      | C_Z  | C_X  | C_C  | GUI  | C_V  |-------|    |-------| Enter| Bspc | Tab  | App  | PScr |      |
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            |      |      |      | #### | /       /       \ Enter\  |MO_FUN|      |      |      |
     *            |      |      |      |      |/       /         \      \ |      |      |      |      |
     *            `----------------------------------'           '------''---------------------------'
     */
    [_EXTEND] = LAYOUT(_______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, _______, _______, KC_ESC, A(KC_LEFT), C(KC_F), A(KC_RGHT), KC_INS, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_CAPS, _______, _______, OS_LALT, OS_LGUI, OS_LSFT, OS_LCTL, OS_RALT, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL, _______, _______, C(KC_Z), C(KC_X), C(KC_C), KC_LGUI, C(KC_V), _______, _______, KC_ENT, KC_BSPC, KC_TAB, KC_APP, KC_PSCR, _______, _______, _______, _______, _______, _______, KC_ENT, MO_FUN, _______, _______, _______),
    ...
    /*
     * Layer 5: FUNCTION (F-keys, Media, Adjust - matches Redox Seniply)
     *
     * ,-----------------------------------------.                    ,-----------------------------------------.
     * |  NO  |  NO  |  NO  |  NO  |  NO  |  NO  |                    |  NO  |  NO  |  NO  |  NO  |  NO  |  NO  |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |  NO  | Stop | Prev | Play | Next | BriU |                    | F12  |  F7  |  F8  |  F9  | ScrL |  NO  |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |  NO  | Alt  | GUI  |Shift | Ctrl | BriD |-------.    ,-------| F11  |  F4  |  F5  |  F6  |DF(0) |  NO  |
     * |------+------+------+------+------+------|  NO   |    |  NO   |------+------+------+------+------+------|
     * |  NO  | Mute | VolD |RCS_C | VolU |RCS_V |-------|    |-------| F10  |  F1  |  F2  |  F3  |DF(1) |  NO  |
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            |      |      |      |      | /       /       \      \  |      |      |      |      |
     *            |      |      |      |      |/       /         \      \ |      |      |      |      |
     *            `----------------------------------'           '------''---------------------------'
     */
    [_FUNCTION] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MSTP, KC_MPRV, KC_MPLY, KC_MNXT, KC_BRIU, KC_F12, KC_F7, KC_F8, KC_F9, KC_SCRL, KC_NO, KC_NO, OS_LALT, OS_LGUI, OS_LSFT, OS_LCTL, KC_BRID, KC_F11, KC_F4, KC_F5, KC_F6, DF(0), KC_NO, KC_NO, KC_MUTE, KC_VOLD, RCS(KC_C), KC_VOLU, RCS(KC_V), KC_NO, KC_NO, KC_F10, KC_F1, KC_F2, KC_F3, DF(1), KC_NO, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______)};
